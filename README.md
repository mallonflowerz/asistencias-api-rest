...
- Para poder acceder a la API desde su Frontend debe poner su url (origen) en el metodo [Origin](https://github.com/mallonflowerz/asistencias/blob/main/src/main/java/com/asistencias/variables/Origin.java)
